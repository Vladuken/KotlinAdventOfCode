...
# Year directories are created in this directory, then each day is saved as year2022.01.png, year2022.02.png, etc.
...
def get_solution_paths_dict_for_years() -> dict[int, dict[int, list[str]]]:
    ...
    E.g.: {2022: {1: [Path("2022/year2022.01/year2022.01.py"), Path("2022/year2022.01/year2022.01.kt")], ...}}
    ...
    print(sorted(get_paths_matching_regex(SRC_AOC_DIR, YEAR_PATTERN), reverse=True))

    for year_dir in sorted(get_paths_matching_regex(SRC_AOC_DIR, YEAR_PATTERN), reverse=True):
